...
import MakingSystem.CreamHolder;
import MakingSystem.CupStack;
import MakingSystem.SugarHolder;
...
public class StockManager {
	...
	private static int amount_cup = CupStack.getCurCupCount();
	...
	public static void addAmount_cup(int amount_cup) {
		CupStack.setCurCupCount(StockManager.amount_cup + amount_cup);
		StockManager.amount_cup += amount_cup;
	}
